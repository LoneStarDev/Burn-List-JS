...
function nft_Array_Sort() {
    return __awaiter(this, void 0, void 0, function () {
        var connection, metaplex, wallet, solana_connection, filters, tokenAccounts, unsafe_nft_array, safe_nft_array, queue, re, nft_lookups;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    nft_lookups = tokenAccounts.forEach(function (account) {
                        var _a, _b;
                        if (!Buffer.isBuffer(account.account.data)) {
                            var newMintAddress_1 = (_b = (_a = account.account.data.parsed) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.mint;
                            if (newMintAddress_1) {
                                var p = function () { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                mintAddress = new web3_js_1.PublicKey(newMintAddress_1);
                                                return [4 /*yield*/, metaplex.nfts().findByMint({ mintAddress: mintAddress })];
                                            case 1:
                                                nft = _b.sent();
                                                if ((_a = nft === null || nft === void 0 ? void 0 : nft.json) === null || _a === void 0 ? void 0 : _a.description) {
                                                    if (re.test(nft.json.description)) {
